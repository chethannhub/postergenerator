...
def main(input_image_path, output_image_path, user_prompt):
    try:
        ...
        font_size_headline = int(height / 10)  # Dynamic font size for headline
        font_size_subhead = int(height / 15)  # Dynamic font size for subhead
        font_size_cta = int(height / 20)  # Dynamic font size for CTA
        ...
        draw_text_with_effects(texts[0], width * 0.05, height * 0.1, font_size_headline)  # Top-left
        draw_text_with_effects(texts[1], width * 0.05, height * 0.2, font_size_subhead)  # Below first text
        draw_text_with_effects(texts[2], width * 0.05, height * 0.3, font_size_cta)  # Below second text
...
if __name__ == "__main__":
    try:
        main('E:\\postergenerator\\temp\\images\\correction_input_20250923_070602_28355b9d.png', 'E:\\postergenerator\\temp\\images\\correction_output_20250923_070602_430f665b.png', '1. Create a Diwali poster with an happy family enjoying fireworks infront of their house.\r\n2. \u20604 member family with 2 adults and 2 kids.\r\n3. \u2060A blue Hyundai Verna is parked to the right side of their house.\r\n4. \u2060Fireworks are reflected on its windshield as if its participating in the\xa0celebration.')
