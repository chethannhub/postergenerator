...
def main(input_image_path, output_image_path, user_prompt):
    try:
        ...
        y_main = height * 0.15  # Adjusted for better placement
...
user_prompt = "Create a Diwali poster with an happy family enjoying fireworks infront of their house."
main(input_image_path, output_image_path, user_prompt)

if __name__ == "__main__":
    try:
        main('E:\\postergenerator\\temp\\images\\correction_input_20250923_062155_a737322e.png', 'E:\\postergenerator\\temp\\images\\correction_output_20250923_062155_bbd0275b.png', '1. Create a Diwali poster with an happy family enjoying fireworks infront of their house.\r\n2. \u20604 member family with 2 adults and 2 kids.\r\n3. \u2060A blue Hyundai Verna is parked to the right side of their house.\r\n4. \u2060Fireworks are reflected on its windshield as if its participating in the\xa0celebration.')
